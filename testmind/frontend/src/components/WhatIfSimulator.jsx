  ...
  return (
    <div className="bg-purple-950/20 border border-purple-800/30 rounded-xl p-4">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-sm font-semibold text-purple-300 font-mono">WHAT-IF SIMULATOR</span>
      </div>
      ...
      <div className="flex items-center gap-4">
        <div className="flex-1">
          <div className="flex justify-between text-xs text-slate-500 mb-1 font-mono">
            ...
            <span className="font-semibold text-purple-400">{xValue} {unit_x}</span>
          ...
          />
          <p className="text-xs text-slate-600 mt-1 font-mono">{property_x?.replace(/_/g, " ")}</p>
        </div>
        <div className="text-center px-4 py-3 bg-[#141820] rounded-xl border border-purple-800/30 shadow-sm min-w-[120px]">
          <p className="text-[10px] text-slate-500 font-mono">PREDICTED</p>
          <p className="text-xl font-bold text-purple-400 font-mono">{predictedY}</p>
...
function TrendSimulator({ data }) {
  ...
  const dirColor = slope_per_month < -0.1 ? "text-red-400" : slope_per_month > 0.1 ? "text-emerald-400" : "text-slate-400";
  ...
  return (
    <div className="bg-purple-950/20 border border-purple-800/30 rounded-xl p-4">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-sm font-semibold text-purple-300 font-mono">TREND SIMULATOR</span>
      </div>
      <p className="text-xs text-slate-400 mb-3 font-mono">
      ...
      <div className="flex items-center gap-4">
        <div className="flex-1">
          <div className="flex justify-between text-xs text-slate-500 mb-1 font-mono">
            <span>Now</span>
            <span className="font-semibold text-purple-400">+{monthsForward} months</span>
            <span>+24 months</span>
          </div>
          <input
            type="range"
          ...
          <div className="flex items-end gap-px mt-2 h-8">
            {forecastPoints.map((p, i) => {
              ...
              return (
                <div
                  key={i}
                  className={`flex-1 rounded-t ${i === 0 ? "bg-blue-500" : "bg-purple-500/60"}`}
        ...
        <div className="text-center px-4 py-3 bg-[#141820] rounded-xl border border-purple-800/30 shadow-sm min-w-[130px]">
          ...
          <p className="text-xs text-slate-500 font-mono">{unit} in {monthsForward}mo</p>
